    ...
    <React.Fragment>
      ...
      <style jsx>
        {`
          ...
          h1 {
            padding: ${theme.space.s} ${theme.space.xs} 0;
          ...
          @from-width tablet {
            ...
            h1 {
              font-size: ${`calc(${theme.font.size.xxl} * 1.2)`};
              padding: ${`calc(${theme.space.s} * 1.5) ${theme.space.s} 0`};
              transition: all ${theme.time.duration.card};
            }
            .meta {
          ...
          @from-width desktop {
            li {
              margin: ${`calc(${theme.space.default} * 4) 0 calc(${theme.space.default} * 4)`};
              padding: 0 0 ${`calc(${theme.space.s} * 2)`};
            ...
            li {
              &:hover {
                ...
                :global(.arrow) {
                  ...
                  stroke: ${theme.color.brand.primaryActive};
